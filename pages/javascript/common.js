...
var pages = ["ranks-summary.html", "ranks-by-dataset.html", "ranks-by-datafile.html", "entropy-plots.html", "interactive-smoothing.html", "performance.html", "figures.html"];
var page_titles = {"ranks-summary.html": "Summary Ranks",
...
function insert_page_header(){
    html = `<div class="page" style="padding: 30px;">
                <h2 style="margin: 0; font-weight: bold;">LineSmooth: An Analytical Framework for Evaluating the <br>Effectiveness of Smoothing Techniques on Line Charts</h2>
                <h3 style="padding-left: 5px; padding-top: 10px;">Paul Rosen and Ghulam Jilani Quadri</h3>`;

	if( new Date() > new Date(2020, 07, 14) )
		html += '<h3 style="padding-left: 5px; padding-top: 10px;">Transactions on Visualization and Computer Graphics, Proceedings of VAST, 2020</h3>';
