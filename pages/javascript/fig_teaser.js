...
function load_teaser(){
    ...
    var dset = 'json/cache/data_eeg_chan10_500_eeg_500_';
	...
	function load_dataset( idx, f, f_level ){
        ...
        d3.json( dset + f + "_" + f_level.toString().replace(".","_") + ".json", function( dinput ) {
...
/*
 ...
 function load_datasets_fig(){
	...
	function load_dataset( idx, ds ){
        ...
        d3.json( "json/cache/data_" + ds['datafile'] + "_" + ds['dataset'] + "_median_0_0.json", function( dinput ) {
...
class SVG_Plot {
 ...
 function load_entropy_plots(){
    ...
    d3.json( "json/cache/metric_eeg_chan10_500_eeg_500.json", function( error, dinput ) {
